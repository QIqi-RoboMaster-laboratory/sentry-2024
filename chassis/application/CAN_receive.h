...
extern  void CAN_shoot_data(uint16_t heat, uint16_t speed, uint8_t game_progress, uint8_t game_progress1, int16_t hp);
...
extern void CAN_game_state(uint16_t time);
