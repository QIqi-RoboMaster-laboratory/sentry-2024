...
typedef enum
{
    ...
    CHASSIS_VECTOR_SPIN,               // 小陀螺模式
	
	CHASSIS_WORLD_FOLLOW_CHASSIS_YAW,
	CHASSIS_WORLD_SPIN,         //BIG TUOLUO
...
typedef enum
{
    CHASSIS_ATTACK, // 击打模式,底盘不动
    CHASSIS_RUN,    // 逃逸模式，底盘小陀螺
} chassis_auto_mode_e;
...
typedef struct 
{
    ...
    auto_HP_t auto_HP;
    //底盘自动模式
    chassis_auto_mode_e chassis_auto_mode;
